  ...
  return (
    <View>
      ...
      <ul style={{ listStyleType: 'initial', marginLeft: 32 }}>
        ...
        <li>
          <strong>
            <Text isTranslatable>Hawaii Unemployment Insurance Account Number.</Text>
          </strong>
        </li>
        <li>
          <Text>
            <Trans key={'createProfileTip2'}>
              <strong>Gross quarterly wages</strong> as reported on Form UC-B6, "Quarterly Wage,
              Contribution and Employment and Training Assessment Report" for the last two completed
              quarters.
            </Trans>
          </Text>
        </li>

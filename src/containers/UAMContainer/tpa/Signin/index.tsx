...
const TPASignin: React.FC<Props> = ({ onShowDialog, onHideDialog }) => {
  ...
  const handleLogin = (values: FormValue) => {
    ...
    const username = `${Tenants.TPA}|${businessId}|${email.trim().toLowerCase()}`;
...
export default connect(mapStateToProps, mapDispatchToProps)(TPASignin);
